...
export async function POST(req: Request) {
    try {
        ...
        const bangladeshTime = new Date(meetingDate.toLocaleString('en-US', { timeZone: 'Asia/Dhaka' }));
        const userTime = new Date(meetingDate.toLocaleString('en-US', { timeZone: Intl.DateTimeFormat().resolvedOptions().timeZone }));
        ...
        const adminMailOptions = {
            ...
            html: `
                ...
                <p><strong>Meeting Time (Bangladesh):</strong> ${bangladeshTime.toLocaleString('en-US', {
                weekday: 'long',
                year: 'numeric',
                month: 'long',
                day: 'numeric',
                ...
                <p><strong>Meeting Time (User's Local):</strong> ${userTime.toLocaleString('en-US', {
                weekday: 'long',
                year: 'numeric',
                month: 'long',
                day: 'numeric',
        ...
        const userMailOptions = {
            ...
            html: `
                ...
                <p><strong>Your Local Time:</strong> ${userTime.toLocaleString('en-US', {
                weekday: 'long',
                year: 'numeric',
                month: 'long',
                day: 'numeric',
                ...
                <p><strong>Bangladesh Time:</strong> ${bangladeshTime.toLocaleString('en-US', {
                weekday: 'long',
                year: 'numeric',
                month: 'long',
                day: 'numeric',
